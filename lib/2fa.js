...
const duoConfig = {
  ikey: process.env.DUO_INTEGRATION_KEY || 'dummy_integration_key',
  skey: process.env.DUO_SECRET_KEY || 'dummy_secret_key',
  akey: process.env.DUO_APPLICATION_KEY || 'dummy_application_key',
  host: process.env.DUO_API_HOSTNAME || 'api-dummy.duosecurity.com',
};
