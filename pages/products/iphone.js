...
export default function IPhoneParts() {
  return (
    <>
      <Head>
        <title>iPhone Parts - Midas Technical Solutions</title>
        <meta name="description" content="High-quality iPhone replacement parts for all models. Screens, batteries, charging ports, and more." />
      </Head>
