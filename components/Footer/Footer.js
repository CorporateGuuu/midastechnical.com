        ...
        <div className={styles.top}>
          <div className={styles.newsletter}>
            ...
            <div className={styles.socialLinks}>
              ...
              <a href="https://instagram.com/mdtstech" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://linkedin.com/company/mdtstech" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
